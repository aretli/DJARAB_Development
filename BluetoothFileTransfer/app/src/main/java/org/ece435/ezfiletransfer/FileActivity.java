...
public class FileActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
            ...
            public void handleMessage(Message message) {
                switch (message.what) {
                    ...
                    case MessageType.COULD_NOT_CONNECT: {
                        Toast.makeText(FileActivity.this, "Could not connect to the paired device", Toast.LENGTH_SHORT).show();
                        break;
                    }
                    ...
                    case MessageType.DATA_SENT_OK: {
                        ...
                        Toast.makeText(FileActivity.this, "Photo was sent successfully", Toast.LENGTH_SHORT).show();
                        break;
                    }

                    case MessageType.DIGEST_DID_NOT_MATCH: {
                        Toast.makeText(FileActivity.this, "Photo was sent, but didn't go through correctly", Toast.LENGTH_SHORT).show();
                        break;
                    }
                }
            }
        ...
        MainApplication.serverHandler = new Handler() {
            ...
            public void handleMessage(Message message) {
                switch (message.what) {
                    ...
                    case MessageType.DIGEST_DID_NOT_MATCH: {
                        Toast.makeText(FileActivity.this, "Photo was received, but didn't come through correctly", Toast.LENGTH_SHORT).show();
                        break;
                    }
                    ...
                    case MessageType.INVALID_HEADER: {
                        Toast.makeText(FileActivity.this, "Photo was sent, but the header was formatted incorrectly", Toast.LENGTH_SHORT).show();
                        break;
                    }
                }
            }
        ...
        if (MainApplication.pairedDevices != null) {
            ...
            ArrayAdapter<DeviceData> deviceArrayAdapter = new ArrayAdapter<DeviceData>(this, R.layout.custom_spinner, deviceDataList);
